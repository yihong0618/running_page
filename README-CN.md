...
## note4: 2023.09.26 garmin need secret_string(and in Actions) get  `python run_page/get_garmin_secret.py ${email} ${password}` if cn `python run_page/get_garmin_secret.py ${email} ${password} --is-cn`
