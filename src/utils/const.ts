...
const CHINESE_INFO_MESSAGE = (yearLength: number, year: string): string =>
  `开始跑步的第 ${yearLength} 年 ` + ( year === 'Total' ? '' : `，地图展示的是 ${year} 年的轨迹`);
...
const CHINESE_LOCATION_INFO_MESSAGE_FIRST =
  '跑过了一些地方，每一段轨迹，都是一次汗水的经历，希望地图点亮的地方越来越多';
...
export const PROVINCE_FILL_COLOR =gold ;
export const COUNTRY_FILL_COLOR = red;
